...
struct Settings {
    ...
    struct Messages {
        ...
        static let ComputerHitMine = "Oh,yes!!!The computer has hit a mine!^_^ You've been awarded an extra move on your next turn."
        static let HumanHitMonster = "No, You've hit a sea monster!@@ RIGHT NOW THE COMPUTER WILL JUST TAKE AN EXTRA TURN..."
